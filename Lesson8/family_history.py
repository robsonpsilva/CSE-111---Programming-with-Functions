...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        print(f'Name: {value[NAME_INDEX]}, Age: {value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]}')
        age_list.append(value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX])
    return age_list
...
def count_genders(people_dict):
    ...
    for key, value in people_dict.items():
        if value[GENDER_INDEX] == 'F':
            ...
            total_men +=1
    print('Genders')
    print(f'Number of males: {total_men}')
    print(f'Number of females: {total_women}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        print(f'Husband Name: {husband_list[NAME_INDEX]} ,Husband Age at Wedding: {value[WEDDING_YEAR_INDEX] - husband_list[BIRTH_YEAR_INDEX]},'\
              + f' Wedding age: {value[WEDDING_YEAR_INDEX]}, Wife name:{wife_list[NAME_INDEX]}, Wife Age at Wedding:{value[WEDDING_YEAR_INDEX] - wife_list[BIRTH_YEAR_INDEX]}')
        print(120 * '_')
